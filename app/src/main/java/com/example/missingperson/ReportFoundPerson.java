...
public class ReportFoundPerson extends AppCompatActivity {
    ...
    TextView tv;
    public static final String UPLOAD_URL = "http://192.168.10.214/lostperson/foundreport.php?add=333";
    ...
    private void uploadImage() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, UPLOAD_URL).addFileToUpload(path, "upload").addParameter("t1", name).addParameter("t2", gender).addParameter("t3",age).addParameter("t4",date).addParameter("t5",time).addParameter("t6",address).addParameter("t7",number).addParameter("t8",marks)
                    .setMaxRetries(3)
                    .startUpload();
            Toast.makeText(ReportFoundPerson.this, "Uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    public void saveData(View view)
    {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ReportFoundPerson.this,MainActivity.class);
